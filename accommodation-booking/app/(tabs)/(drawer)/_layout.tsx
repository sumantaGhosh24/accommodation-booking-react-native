  ...
  return (
    <GestureHandlerRootView style={{flex: 1}}>
      ...
      >
        ...
        <Drawer.Screen
          name="my-ratings"
          options={{drawerLabel: "My Ratings", title: "My Ratings"}}
          redirect={authState?.accesstoken === null}
        />
        ...
        <Drawer.Screen
          name="manage-hotels"
          options={{drawerLabel: "Manage Hotels", title: "Manage Hotels"}}
          redirect={authState?.role !== Role.ADMIN}
        />
        <Drawer.Screen
          name="manage-ratings"
          options={{drawerLabel: "Manage Ratings", title: "Manage Ratings"}}
          redirect={authState?.role !== Role.ADMIN}
        />
        <Drawer.Screen
